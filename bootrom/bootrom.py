...
def boot_rom():
    ...
    title = bytearray.fromhex(rom.getrange(16))
    ...
    liscensee_code_1 = rom.get()
    liscensee_code_2 = rom.get()
    try:
    ...
    glob_check_1 = rom.get()
    glob_check_2 = rom.get()
