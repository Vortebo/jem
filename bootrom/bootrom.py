...
def boot_rom(rom):
    ...
    rg.pc.value = '0104'
    rom_logo = rom.getrange(rg.pc, 48)
    ...
    title = bytearray.fromhex(rom.getrange(rg.pc, 16))
    ...
    liscensee_code_1 = rom.get(rg.pc)
    liscensee_code_2 = rom.get(rg.pc)
    try:
